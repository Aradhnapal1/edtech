...
<div class="dashboard-body">
    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="flex-align justify-content-end gap-8">
            ...
            <button type="button" class="btn btn-main rounded-pill py-9" id="publishBatch">Publish Batch</button>
        </div>
        <!-- Buttons End -->
    </div>
                    ...
                    <div class="col-xxl-9 col-md-8 col-sm-7">
                        <div class="row g-20">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="position-relative">
                                    <select id="courseName" class="form-select py-9 placeholder-13 text-15">
