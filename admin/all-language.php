    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                ...
                <li><span class="text-main-600 fw-normal text-15">Language</span></li>
            </ul>
        </div>
        <!-- Breadcrumb End -->
...
<div class="card overflow-hidden">
  <div class="card-body p-0 overflow-x-auto">
    <table id="languageTable" class="table table-striped align-middle  ">
      <thead>
        <tr>
          ...
          <th class="h6 text-gray-300">Language</th>
          <th class="h6 text-gray-300">Status</th>
          <th class="h6 text-gray-300 text-center">Edit</th>
          <th class="h6 text-gray-300 text-center">Delete</th>
        </tr>
      </thead>
