...
<div class="dashboard-body">
    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                ...
                <li><span class="text-main-600 fw-normal text-15">All Category</span></li>
            </ul>
        </div>
        <!-- Breadcrumb End -->
    ...
    <div class="card overflow-hidden">
        <div class="card-body p-0 overflow-x-auto">
            <table id="studentTableeeee" class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="h6 text-gray-300">All Category</th>
                        <th class="h6 text-gray-300">Category Description</th>
...
<script>
    ...
    document.getElementById('exportOptions').addEventListener('change', function() {
        ...
        const table = document.getElementById('studentTableeeee');
        let data = [];
        const headers = [];
    ...
    // Data Tables
    new DataTable('#studentTableeeee', {
        searching: false,
        lengthChange: false,
