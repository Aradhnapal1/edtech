    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                ...
                <li><span class="text-main-600 fw-normal text-15">Batch</span></li>
            </ul>
        </div>
        <!-- Breadcrumb End -->
            ...
            <table id="batchTable" class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="h6 text-gray-300">Batch Name</th>
                        ...
                        <th class="h6 text-gray-300">Total Students</th>
...
<script>
    ...
    new DataTable('#facultyTable', {
        ...
        columnDefs: [{
            orderable: false,
            targets: [0, 7] // Updated because Actions is now column 7
        }]
    });
