...
<div class="dashboard-body">
    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="flex-align justify-content-end gap-8">
            ...
            <button type="submit" class="btn btn-main rounded-pill py-9" id="publishEditReview">Edit Review</button>
        </div>
            ...
            <form id="editReviewForm">
                <div class="row gy-20">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control py-11" id="editTitle" placeholder="Enter Review Name" required>
                    </div>

                    <div class="col-sm-6">
                        <label class="h5 mb-8 fw-semibold">Review Course</label>
                        <select id="editcourseSelect" class="form-select py-9" required>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="email" class="form-control py-11" id="editEmail" placeholder="Enter Email" required>
                    </div>

                    <div class="col-sm-6">
                        <label class="h5 mb-8 fw-semibold">Review Rating</label>
                        <div class="star-rating d-flex gap-1" id="editRating">
                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                <i class="ph ph-star text-2xl text-gray-400 cursor-pointer" data-value="<?= $i ?>"></i>
                            <?php endfor; ?>
                        </div>
                        <input type="hidden" name="review_rating" id="editRatingValue" required>
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <textarea class="form-control py-11" id="editReviewText" rows="3" maxlength="500" required></textarea>
                    </div>
