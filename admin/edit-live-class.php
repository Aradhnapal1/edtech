...
<div class="dashboard-body">
    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                ...
                <li><span class="text-main-600 fw-normal text-15">Edit Class Upload</span></li>
            </ul>
        </div>
        ...
        <div class="flex-align justify-content-end gap-8">
            ...
            <button type="button" class="btn btn-main rounded-pill py-9" id="editLiveClass">Publish Live Class</button>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header border-bottom border-gray-100 flex-align gap-8">
            ...
            <button type="button" class="text-main-600 text-md d-flex" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Live Class Details">
            ...
            <form action="#">
                <div class="row gy-20">
                    <div class="col-xxl-3 col-md-4 col-sm-5">
                        <div class="mb-20">
                            <label class="h5 fw-semibold font-heading mb-0">Live Class Thumbnail <span class="text-13 text-gray-400 fw-medium">(Required)</span></label>
                        </div>
                    ...
                    <div class="col-xxl-9 col-md-8 col-sm-7">
                        <div class="row g-20">
                            ...
                            <!-- Live Class Name -->
                            <div class="col-sm-12">
                                <label for="liveClassName" class="h5 mb-8 fw-semibold font-heading">Live Class Name </label>
                                <div class="position-relative">
                                    <input type="text" class="form-control py-11" id="liveClassName" placeholder="Enter Live Class Name">
                                </div>
                            </div>
