    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                ...
                <li><span class="text-main-600 fw-normal text-15">Course Category</span></li>
            </ul>
        </div>
        <!-- Breadcrumb End -->
                ...
                <label for="fileUpload-2" class="file-upload image-upload__box">
                    ...
                    <div class="col-xxl-9 col-md-8 col-sm-7">
                        <div class="row g-20">
                            <!-- Category Name Input -->
                            <!-- <div class="col-sm-12">
                                <label for="courseTitle" class="h5 mb-8 fw-semibold font-heading">Category Name<span class="text-13 text-gray-400 fw-medium">(Required)</span> </label>
                            ...
                            <div class="col-sm-12">
                                <label for="subcategoryName" class="h5 mb-8 fw-semibold font-heading">Subcategory Name<span class="text-13 text-gray-400 fw-medium">(Required)</span> </label>
                                <div class="position-relative">
                                    <input type="text" class="form-control py-11" id="subcategoryName" placeholder="Subcategory Name">
                                </div>
                            </div>

                            <!-- Parent Category Dropdown -->
                            <div class="col-sm-6">
                                <label for="parentCategory" class="h5 mb-8 fw-semibold font-heading">Parent Category<span class="text-13 text-gray-400 fw-medium">(Required)</span> </label>
                                <div class="position-relative">
                                    <select class="form-control py-11" id="parentCategory">
                            ...
                            <div class="col-sm-6">
                                <label for="categoryDescription" class="h5 mb-8 fw-semibold font-heading">Category Description</label>
                                <textarea id="categoryDescription" class="form-control py-11 placeholder-13" rows="4" placeholder="Enter category description"></textarea>
                            </div>
