    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                ...
                <li><span class="text-main-600 fw-normal text-15">Blog</span></li>
            </ul>
        </div>
        <!-- Breadcrumb End -->
...
<table id="blogTable" class="table table-striped">
    <thead>
        <tr>
            ...
            <th class="h6 text-gray-300">Blog</th>
    ...
    <tr>
        ...
        <td class="align-middle">
            <div class="d-flex align-items-center gap-8">
                <img src="assets/images/thumbs/blogTable-img1.png"
                    class="w-40 h-40 rounded-circle" alt="">
        ...
        <!-- Edit -->
        <td class=" align-middle">
            <i class="bi bi-pencil-square text-success fs-5 cursor-pointer"></i>
        </td>
...
<script>
    ...
    if (typeof ensureDtColumnOrderSpans === 'function') {
        ensureDtColumnOrderSpans('#blogTable');
    }
</script>
