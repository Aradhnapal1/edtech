            ...
            <table id="courseTable" class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="h6 text-gray-300">Coupon</th>
                        <th class="h6 text-gray-300">Discount Type</th>
                        <th class="h6 text-gray-300">Discount Value</th>
                        <th class="h6 text-gray-300">Min Order Value</th>
                        <th class="h6 text-gray-300">Max Discount</th>
