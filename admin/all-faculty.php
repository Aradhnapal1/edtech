...
<table id="blogTable" class="table table-striped">
    <thead>
        <tr>
            ...
            <th class="h6 text-gray-300">Experience</th>
            <th class="h6 text-gray-300">Specialization</th>
...
<script>
    ...
    new DataTable('#blogTable', {
        ...
        "columnDefs": [
            { "orderable": false, "targets": [0,9,8,7,6,5,4,3,2,1] } // Disables sorting on the 7th column (index 6)
        ]
    });
