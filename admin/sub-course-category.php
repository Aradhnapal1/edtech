...
<div class="dashboard-body">
    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                ...
                <li><span class="text-main-600 fw-normal text-15">Sub Category </span></li>
            </ul>
        </div>
        <!-- Breadcrumb End -->
    ...
    <div class="card overflow-hidden">
            ...
            <table id="facultyTable" class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="h6 text-gray-300">Sub Category Name</th>
                        <th class="h6 text-gray-300">Sub Category Description</th>
                        <th class="h6 text-gray-300">Parent Category</th> <!-- New -->
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex-align gap-8">
                                ...
                                <span class="h6 mb-0 fw-medium text-gray-300">Sub Category Name</span>
                            </div>
                        </td>
                        <td>
                            <span class="h6 mb-0 fw-medium text-gray-300">Description</span>
                        </td>
                        <td> <!-- Parent Category -->
                            <span class="h6 mb-0 fw-medium text-gray-300">Parent Category Name</span>
                        </td>
                        <td>
                        ...
                        <td>
                            <a href="#" class="bg-main-50 text-main-600 py-2 px-14 rounded-pill hover-bg-main-600 hover-text-white">Edit</a>
                        </td>
                    </tr>
        ...
        <div class="card-footer flex-between flex-wrap">
            <!-- <span class="text-gray-900">Showing 1 to 2 of 2 entries</span>
...
<script>
    ...
    new DataTable('#facultyTable', {
        ...
        columnDefs: [{
            orderable: false,
            targets: [0, 5] // Updated because Actions is now column 5
        }]
    });

    if (typeof ensureDtColumnOrderSpans === 'function') {
        ensureDtColumnOrderSpans('#facultyTable');
    }
</script>
