...
<!-- Mirrored from htmldemo.net/edumall/edumall/dashboard-index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Apr 2025 09:36:03 GMT -->
...
<head>
    ...
    <script src="./js/user-enroll-course.js"></script>
        ...
        <div class="dashboard-nav__wrapper">
            ...
            <div class="offcanvas-header dashboard-nav__header dashboard-nav-header">
                ...
                <!-- <div class="dashboard-nav__logo">
                    <a class="logo" href="index.php"><img src="assets/images/hyperscripts.png" alt="Logo" width="298" height="62"></a>
                </div> -->
                <div class="header-logo">
                    <a class="header-logo__logo" href="index.php"><img src="assets/images/career.png" width="296"
    ...
    <div class="dashboard-header">
        <div class="container">
            ...
            <div class="dashboard-header__wrap">
                ...
                <div class="dashboard-header__user">
                    <div class="dashboard-header__user-avatar">
                        <img id="dashboardUserAvatar" src="" alt="User" width="90"
                            height="90">
                    </div>
                ...
                <div class="dashboard-header__btn">
                    <a class="btn btn-outline-primary" href="course.php"><i class="edumi edumi-content-writing"></i>
                        <span class="text">Buy A New Course </span></a>
