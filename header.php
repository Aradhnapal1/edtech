...
<!-- Mirrored from htmldemo.net/edumall/edumall/index-education-center.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Apr 2025 09:35:45 GMT -->
...
<script src="https://checkout.razorpay.com/v1/checkout.js"></script>
   ...
   <script src="./js/get-all-category.js"></script>
   <script src="./js/get-all-course.js"></script>
               ...
               <div class="header-top-bar-wrap d-sm-flex justify-content-between">
                  ...
                  <div class="header-top-bar-wrap__info">
                     <ul class="header-top-bar-wrap__info-list">
                        <li><a href="tel:8527430152"><i class="fas fa-phone"></i> <span class="info-text">8527430152</span></a></li>
                        <li><a href="mailto:info@hyperscripts.in"><i class="far fa-envelope"></i> <span class="info-text">info@hyperscripts.in</span></a></li>
                     </ul>
                  </div>
            ...
            <div class="container">
               ...
               <div class="header-main-wrapper">
                  ...
                  <div class="header-logo">
                     <a class="header-logo__logo" href="index.php"><img src="assets/images/career.png" width="296" height="64" alt="Logo"></a>
                  </div>
                  <!-- Header Logo End -->
                  ...
                  <div class="header-category-menu d-none d-xl-block">
                     ...
                     <div class="header-category-dropdown-wrap">
                        <ul class="header-category-dropdown"  id="categoryHeaderList">
                  ...
                  <div class="header-inner">
                     ...
                     <div class="header-serach">
                        <form action="#" id="globalCourseSearchForm">
                           <input type="text" class="header-serach__input" id="globalCourseSearchInput" placeholder="Search...">
                     ...
                     <div class="header-navigation d-none d-xl-block">
                        <nav class="menu-primary">
                           <ul class="menu-primary__container">
                              <li>
                                 <a class="main_tab " href="index.php"><span>Home</span></a>
                             </li>
                              <li>
                                 <a class="main_tab" href="about.php"><span>About Us</span></a>

                              </li>
                              <li>
                                 <a class="main_tab" href="course.php"><span>Courses</span></a>
                              </li>
                              <li>
                                 <a class="main_tab" href="blog.php"><span>Blog</span></a>

                              </li>
                             
                              <li>
                                 <a class="main_tab" href="contact-us.php"><span>Contact Us</span></a>
                     ...
                     <div class="header-action">
                        <a href="./cart.php" class="header-action__btn">
                           <i class="fas fa-shopping-basket"></i>
                           <span class="header-action__number" id="count"></span>
                        </a>
                        ...
                        <div class="header-mini-cart">
                           ...
                           <ul class="header-mini-cart__product-list " id="miniCartList">
                              <li class="header-mini-cart__item">
                                 <a href="#" class="header-mini-cart__close"></a>
                                 <div class="header-mini-cart__thumbnail">
                                    <a href="#"><img src="assets/images/product/product-1.png" alt="Product" width="80" height="93"></a>
                                 </div>
                              ...
                              <li class="header-mini-cart__item">
                                 <a href="#" class="header-mini-cart__close"></a>
                                 <div class="header-mini-cart__thumbnail">
                                    <a href="#"><img src="assets/images/product/product-2.png" alt="Product" width="80" height="93"></a>
                                 </div>
                                 <div class="header-mini-cart__caption">
                                    <h3 class="header-mini-cart__name"> <a href="#">Awesome for Websites</a></h3>
                                    <span class="header-mini-cart__quantity">1 × <strong class="amount">$49</strong><span class="separator">.00</span></span>
                              ...
                              <li class="header-mini-cart__item">
                                 <a href="#" class="header-mini-cart__close"></a>
                                 <div class="header-mini-cart__thumbnail">
                                    <a href="#"><img src="assets/images/product/product-3.png" alt="Product" width="80" height="93"></a>
                                 </div>
                                 <div class="header-mini-cart__caption">
                                    <h3 class="header-mini-cart__name"> <a href="#">Awesome for Websites</a></h3>
                                    <span class="header-mini-cart__quantity">1 × <strong class="amount">$49</strong><span class="separator">.00</span></span>
                           ...
                           <div class="header-mini-cart__footer">
                              <div class="header-mini-cart__total">
                                 ...
                                 <p class="header-mini-cart__value">$0<span class="separator"></span></p>
                              </div>
                              <div class="header-mini-cart__btn">
                                 <a href="cart.php" class="btn btn-primary btn-hover-secondary">View cart</a>
                                 <span class="btn btn-primary btn-hover-secondary" id="headerCheckout">Checkout</span>
                              </div>
                           </div>
...
<form id="loginForm" action="#">
               ...
               <div class="modal-body">
                  ...
                  <form action="#" id="registerForm">
                     <div class="row gy-5">
                        ...
                        <div class="col-md-12">
                           <div class="modal-form">
                              <button type="submit" id="registerButton" class="btn btn-primary btn-hover-secondary w-100">
                                 Register
                              </button>
                           </div>
                        </div>
   ...
   <!-- Log In Modal End -->
<!-- main header tab active js -->
<script>
document.addEventListener("DOMContentLoaded", function () {
    const tabs = document.querySelectorAll('.main_tab');
...
<script>
document.addEventListener("DOMContentLoaded", function () {
    const form = document.getElementById("globalCourseSearchForm");
    const input = document.getElementById("globalCourseSearchInput");
    ...
    form.addEventListener("submit", function (event) {
        ...
        const targetUrl = searchText
            ? `course.php?search=${encodeURIComponent(searchText)}`
            : "course.php";
