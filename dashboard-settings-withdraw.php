...
<!-- Mirrored from htmldemo.net/edumall/edumall/dashboard-settings-withdraw.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Apr 2025 09:36:34 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="dashboard-settings">
                    ...
                    <div class="dashboard-tabs-menu">
                        <ul>
                            ...
                            <li><a class="active" href="dashboard-settings-withdraw.php">withdraw</a></li>
                        </ul>
                    </div>
                    <!-- Dashboard Tabs End -->
